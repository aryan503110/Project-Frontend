...
const AdminAllStockRequest = () => {
  ...
  const handleRejectStockRequest = async (id) => {
    setLoading(true);
    try {
      const res = await axios.put(
                  ...
                  <td className="px-4 py-4 sm:px-6 sm:py-5">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => {
                          handleApproveStockRequest(item?._id);
                        }}
                        type="button"
                      ...
                      <button
                        onClick={() => {
                          handleRejectStockRequest(item?._id);
                        }}
                        disabled={item?.status != "pending"}
                        type="button"
...
export default AdminAllStockRequest;

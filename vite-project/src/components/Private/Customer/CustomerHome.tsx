...
const CustomerHome = () => {
  ...
  return (
    <section className="max-w-2xl">
      <h1 className="text-2xl font-bold text-[#222] sm:text-4xl">Customer Home</h1>
      <p className="mt-2 text-sm text-gray-500 sm:text-base">Browse products and keep track of your orders.</p>
